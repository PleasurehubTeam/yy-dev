---
name: investigate
description: Use when diagnosing issues — 4-phase systematic investigation with optional transition to fix
---
...
4. If user confirms → Execute full fix workflow (same as `/yy:fix`):
   - TDD: Write failing test → Fix → Verify (invoke `superpowers:test-driven-development`)
